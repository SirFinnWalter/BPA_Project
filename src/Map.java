...
public class Map {
    ...
    public void renderMap(RenderHandler renderer, int xZoom, int yZoom) {
        for (int i = 0; i < mappedTiles.size(); i++) {
            ...
            int yIncrement = mappedTile.getTile().sprite.getHeight() * yZoom;

            tileSet.renderTiles(mappedTile.id, renderer, mappedTile.x * xIncrement, mappedTile.y * yIncrement, xZoom,
                    yZoom);
        }
    }
